...
then
  sudo dnf install -y tilix NetworkManager-tui the_silver_searcher tmux rofi arandr pavucontrol java-1.8.0-openjdk-devel feh compton xclip network-manager-applet polybar
